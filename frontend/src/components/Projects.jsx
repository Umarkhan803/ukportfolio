...
const Projects = () => {
  ...
  <div className="container mx-auto px-6">
    ...
    <div className="text-center mt-12">
      <a href="https://github.com/Umarkhan803" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-md bg-[#212121] px-6 py-3 text-white hover:bg-[#1E88E5] transition-colors duration-300">
