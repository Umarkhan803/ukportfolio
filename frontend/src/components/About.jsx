      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-2/5 animate__animated animate__fadeInLeft">
            ...
            <a href="https://github.com/Umarkhan803" target="_blank" rel="noopener noreferrer" className="w-10 h-10  hover:text-blue-500 rounded-full flex items-center justify-center transition-colors" aria-label="GitHub">
                  ...
                  <a href="https://www.linkedin.com/in/mohmmedumarkhan803/" target="_blank" rel="noopener noreferrer" className="w-10 h-10  hover:text-blue-500 rounded-full flex items-center justify-center transition-colors" aria-label="LinkedIn">
                    <svg className="w-7 h-7  " fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
