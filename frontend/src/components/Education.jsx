    ...
    const educationData = [
        {
          ...
          description: "Graduated with Computer Application. Focused on web development, databases, and software engineering.",
          iconBg: "bg-[#1E88E5]",
        ...
        {
          year: "2024",
          degree: "Full Stack Development with React & Node JS",
